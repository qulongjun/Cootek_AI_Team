...
Page({
  data: {
    ...
    list: [
      ...
      { id: 1, 'type': 'jw', name: '公司公告',storage:[], url: 'news/jw_list.php', enabled: {guest:false, student:true, teacher:true} },
      { id: 2, 'type': 'oa', name: '部门公告',storage:[], url: 'news/oa_list.php', enabled: {guest:false, student:true, teacher:true} },
